...
- Data dir: `data/symbolic-0_28-term-verify-hardened`
- Status: `pass`
- Errors: `0`
- Warnings: `0`
...
- Examples: `18987`
- Problems: `1656`
- Families: `{'graph_reachability': 4154, 'implication_chains': 3672, 'relation_composition': 3178, 'term_rewriting': 3819, 'tree_ancestry': 4164}`
- Modes: `{'action': 8795, 'repair_action': 8464, 'verify': 1728}`
...
- Inputs shape: `[18987, 850]`
- Labels shape: `[18987, 850]`
- Seq len: `850`
- Vocab size: `304`
- Puzzle identifiers unique: `[0]`
- Non-empty target rows: `18987`
