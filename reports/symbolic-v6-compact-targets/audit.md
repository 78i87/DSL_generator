...
- Data dir: `data/symbolic-v6-compact-targets`
- Status: `pass`
- Errors: `0`
- Warnings: `0`
...
- Inputs shape: `[5744, 250]`
- Labels shape: `[5744, 250]`
- Seq len: `250`
- Vocab size: `132`
...
- Inputs shape: `[708, 250]`
- Labels shape: `[708, 250]`
- Seq len: `250`
- Vocab size: `132`
- Puzzle identifiers unique: `[0]`
...
- Inputs shape: `[1080, 250]`
- Labels shape: `[1080, 250]`
- Seq len: `250`
- Vocab size: `132`
- Puzzle identifiers unique: `[0]`
...
```text
REPLACE LINE 0 WITH DERIVE p0 BY h0
```
...
```text
REPLACE LINE 0 WITH DERIVE r8 e0 e2 VIA e1
```
...
```text
REPLACE LINE 0 WITH DERIVE r3 e0 e2 VIA e1
```
